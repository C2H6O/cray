...
public class LeaseDao extends AbstractDao<Lease, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LeaseDate = new Property(3, Long.class, "leaseDate", false, "LEASE_DATE");
        public final static Property ReturnDate = new Property(4, Long.class, "returnDate", false, "RETURN_DATE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LEASE\" (" + //
                ...
                "\"LEASE_DATE\" INTEGER," + // 3: leaseDate
                "\"RETURN_DATE\" INTEGER," + // 4: returnDate
